  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-12">
      ...
      <form className="w-full max-w-md bg-blue-500 p-6 rounded-lg shadow-lg text-[#fff]" onSubmit={(e) => sendData(e)} encType="multipart/form-data">
        ...
        <input type="text" name='price' value={formData.price || ''} onChange={handleInputChange} placeholder={`Price ${(required.price) ? '*' : ''}`} className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        <input type="text" name='condition' value={formData.condition || ''} onChange={handleInputChange} placeholder={`Condition ${(required.condition) ? '*' : ''}`} required className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        ...
        <input type="text" name='year' value={formData.year || ''} onChange={handleInputChange} placeholder={`Year ${(required.year) ? '*' : ''}`} required className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        ...
        <input type="text" name='axle' value={formData.axle || ''} onChange={handleInputChange} placeholder={`Axle ${(required.axle) ? '*' : ''}`} required className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        <input type="text" name='mileage' value={formData.mileage || ''} onChange={handleInputChange} placeholder={`Mileage ${(required.mileage) ? '*' : ''}`} required className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        ...
        <input type="text" name='engineType' value={formData.engineType || ''} onChange={handleInputChange} placeholder={`Engine Type ${(required.engineType) ? '*' : ''}`} required className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        ...
        <input type="text" name='transmissionType' value={formData.transmissionType || ''} onChange={handleInputChange} placeholder={`Transmission Type ${(required.transmissionType) ? '*' : ''}`} className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        <input type="text" name='seatingCapacity' value={formData.seatingCapacity || ''} onChange={handleInputChange} placeholder={`Seating Capacity ${(required.seatingCapacity) ? '*' : ''}`} className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        <input type="text" name='engineCapacity' value={formData.engineCapacity || ''} onChange={handleInputChange} placeholder={`Engine Capacity ${(required.engineCapacity) ? '*' : ''}`} className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
        <input type="text" name='warranty' value={formData.warranty || ''} onChange={handleInputChange} placeholder={`Warranty ${(required.warranty) ? '*' : ''}`} className="w-full p-3 my-2 rounded-md bg-blue-400 placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
