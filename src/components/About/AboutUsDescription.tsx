...
const AboutUsDescription: React.FC = () => {
  return (
    ...
    style={{backgroundImage: 'linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url(/assests/AboutUsBgImage.jpg)',}}>
      <div className='xs:w-[50vw] text-center'>
        <h1 className='text-4xl text-textColor-heading font-playfair font-semibold'>ABOUT US</h1>
