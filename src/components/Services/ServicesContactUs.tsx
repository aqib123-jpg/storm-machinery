...
const ServicesContactUs: React.FC = () => {
  return (
    ...
    style={{backgroundImage: 'linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url(/assests/BlackTruck.jpeg)',}}>
      <div className="mb-8">
        <h1 className="text-5xl md:text-8xl font-bold text-textColor-heading mb-4 font-playfair">Contact Us</h1>
        <div className="text-[#FFBA25] text-4xl md:text-5xl">
          <span>★★★★★</span>
        </div>
      </div>

      <div className="w-4/5 max-w-2xl text-center text-textColor-default text-lg space-y-6 font-inter italic leading-8">
        <p>
        ...
        <p className="flex items-center justify-center space-x-2 text-textColor-subheading">
