...
const SalesTeam: React.FC = () => {
  ...
  return (
    <div className="my-20 text-center p-5">
      <h2 className="text-3xl font-bold mb-4 text-textColor-heading font-playfair">Professional Sales Team</h2>
      <p className="mb-8 text-xl font-inter text-textColor-default leading-relaxed max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {teamMembers.map((member, index) => (
          <div key={index} className="flex flex-col items-center p-4 border border-gray-300 rounded-lg shadow-md transition-transform duration-500 ease-in-out hover:-translate-y-2 hover:shadow-lg">
            ...
            <h3 className="text-xl font-playfair font-semibold text-textColor-subheading mb-2">{member.name}</h3>
